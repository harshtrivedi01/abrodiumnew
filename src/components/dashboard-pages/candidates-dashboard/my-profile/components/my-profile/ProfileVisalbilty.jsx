  ...
  return (
    <>
      <form className="default-form">
        <p>
          {" "}
          your profile visalibilty controls if you can be approached by
          empolyers and recruiters with job opportunities
        </p>
        <div className="form-group col-lg-6 col-md-12">
          <label>select a profile visibility level</label>
          <select className="" required>
            <option value="standard" className="w-full">
              <div className="flex flex-col border gap-6 h-20 w-20">
                <h6 className="text-md">Standard</h6>
                {/* <div className="flex mt-4">
                  Empolyers can view my profile and resume and contact me
                  directly or via seek{" "}
                </div> */}
              </div>
            </option>
